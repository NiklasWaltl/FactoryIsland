...
- Die App nutzt ~10 unabhängige `setInterval`-Ticks.
- Die Reihenfolge der Tick-Ausführung innerhalb eines Browser-Frames ist nicht garantiert.
- Tick-Logik muss als pure Funktion über `state` formuliert sein.
- Tick-Handler dürfen nicht davon ausgehen, dass ein anderer Tick direkt vorher oder nachher gelaufen ist.
