...
export const BatteryPanel: React.FC<BatteryPanelProps> = React.memo(
  ({ state, dispatch }) => {
    ...
    const isConnected = batteryAsset
    ...
    return (
      ...
      >
        ...
        <div className="fi-generator-energy-label" style={{ marginBottom: 8 }}>
          <span>🔌 Netzwerk</span>
          <span
            className={`fi-debug-badge ${isConnected ? "fi-debug-badge--active" : "fi-debug-badge--inactive"}`}
        ...
        <div className="fi-generator-energy-bar-wrap">
          <div className="fi-generator-energy-label">
            ...
            <span className={`fi-battery-status ${statusClass}`}>
              {statusLabel}
            </span>
          </div>
          ...
          <div className="fi-generator-bar-meta">
            <span>
              {Math.floor(b.stored)} / {b.capacity} J
            </span>
        ...
        {isConnected && (
          ...
          >
            <span>
              Eingang:{" "}
              <strong style={{ color: "#7fff7f" }}>+{production} J/2s</strong>
            </span>
            <span>
              Ausgang:{" "}
        ...
        <div style={{ marginTop: 12, color: "#aaa", fontSize: 11 }}>
          <p>
            Lädt, wenn Generatoren mehr produzieren als Maschinen verbrauchen.
          </p>
          <p>
            Entlädt, wenn Maschinen mehr verbrauchen als Generatoren liefern.
          </p>
