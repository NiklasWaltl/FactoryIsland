...
export const BUILDING_REGISTRY: Readonly<Record<BuildingType, BuildingDef>> =
  Object.freeze({
    workbench: {
      type: "workbench",
      label: "Werkbank",
    ...
    power_pole: {
      ...
      label: "Stromknoten",
      description:
        "Verteilt Energie kabellos an Gebäude in Reichweite (3 Felder).",
      category: "energy",
      cost: { wood: 3, stone: 5 },
      size: 1,
      stackable: true,
    ...
    auto_miner: {
      ...
      label: "Auto-Miner",
      description:
        "Baut automatisch Ressourcen von Vorkommen ab. Nur auf 2×2 Deposits. Benötigt Energie. R zum Drehen.",
      category: "production",
    ...
    conveyor: {
      ...
      label: "Förderband",
      description:
        "Transportiert Items automatisch in eine Richtung. Benötigt Energie. R zum Drehen.",
      category: "logistics",
      cost: { iron: 2 },
      size: 1,
      stackable: true,
    ...
    conveyor_corner: {
      ...
      description:
        "Leitet Items in einer 90°-Ecke weiter. Benötigt Energie. R zum Drehen.",
      category: "logistics",
      cost: { iron: 3 },
      size: 1,
      stackable: true,
    ...
    conveyor_merger: {
      ...
      description:
        "Führt zwei seitliche Förderbänder auf einen Ausgang zusammen. Links hat Vorrang. Benötigt Energie. R zum Drehen.",
      category: "logistics",
      cost: { iron: 4 },
      size: 1,
      stackable: true,
    ...
    conveyor_splitter: {
      ...
      description:
        "Teilt den Strom vom Rücken-Eingang auf zwei seitliche Ausgänge. Links hat Vorrang. Benötigt Energie. R zum Drehen.",
      category: "logistics",
      cost: { iron: 4 },
      size: 1,
      stackable: true,
    ...
    manual_assembler: {
      ...
      description:
        "Stellt per Hand Metallplatten und Zahnräder her. Keine Energie nötig.",
      category: "production",
      cost: { wood: 10, iron: 4 },
      size: 2,
      stackable: false,
    ...
    auto_smelter: {
      ...
      label: "Auto Smelter",
      description:
        "Automatisches Schmelzen per Förderband. 2×1, rotierbar, Input/Output auf gegenüberliegenden Seiten.",
      category: "production",
    ...
    service_hub: {
      ...
      label: "Drohnen-Hub",
      description:
        "Platziert einen Proto-Hub (Stufe 1). Kann später zu einem Service-Hub (Stufe 2) aufgerüstet werden.",
      category: "hub",
...
export function lookupBuildingInputConfig(
  ...
  const def = (BUILDING_REGISTRY as Record<string, BuildingDef | undefined>)[
    type
  ];
